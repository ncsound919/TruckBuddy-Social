...
import { Truck, Radio, Bell, CheckSquare, X, Smartphone, Download } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-3 cursor-pointer group" onClick={() => { setActiveSection('feed'); window.scrollTo(0,0); }}>
            ...
            <div>
              <h1 className="text-xl font-black text-white tracking-tighter leading-none group-hover:text-amber-400 transition-colors">TRUCK BUDDY <span className="text-amber-500 font-normal">NETWORK</span></h1>
            ...
            <div className="hidden lg:flex items-center">
              {isIOS && !isInstalled ? (
                <button
                  ...
                  className="bg-zinc-100 hover:bg-zinc-200 text-slate-800 font-black tracking-wider uppercase text-[10px] px-4 py-2 rounded-xl transition-colors flex items-center shadow-sm"
                >
                ...
                <button
                  onClick={install}
                  className="bg-amber-500 hover:bg-amber-400 text-slate-950 font-black tracking-wider uppercase text-[10px] px-4 py-2 rounded-xl transition-colors flex items-center shadow-md"
                >
